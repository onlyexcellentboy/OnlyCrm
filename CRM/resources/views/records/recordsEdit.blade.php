...
<div style="width:860px;margin:0 auto;padding-top:20px;">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">跟单名称</label>
            <div class="layui-input-block">
                <input type="text" name="roleName" win-verify="required" placeholder="请输入跟单名称" autocomplete="off" class="layui-input" value="&#x8D85;&#x7EA7;&#x7BA1;&#x7406;&#x5458;" />
            </div>
        </div>
        <div class="layui-form-item">
