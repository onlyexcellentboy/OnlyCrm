...
<div  class="layui-anim layui-anim-rotate layui-anim-up" data-anim="layui-anim-up">
    <div class="winui-toolbar">
        <div class="winui-tool">
            ...
            <button id="addOrder" class="winui-toolbtn"><i class="fa fa-plus" aria-hidden="true"></i>新增订单</button>
            <button id="deleteOrder" class="winui-toolbtn"><i class="fa fa-trash" aria-hidden="true"></i>删除选中</button>
        </div>
    </div>
    <div style="margin:auto 10px;">
        <table id="order" lay-filter="ordertable"></table>
