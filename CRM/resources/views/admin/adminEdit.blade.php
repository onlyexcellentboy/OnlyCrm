    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="roleName" win-verify="required" placeholder="请输入管理员名称" autocomplete="off" class="layui-input" value="&#x8D85;&#x7EA7;&#x7BA1;&#x7406;&#x5458;" />
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">手机号</label>
            <div class="layui-input-block">
                <input type="text" name="description" win-verify="required" placeholder="请输入管理员手机号" autocomplete="off" class="layui-input" value="&#x53EF;&#x67E5;&#x770B;&#x6240;&#x6709;&#x83DC;&#x5355;&#xFF0C;&#x53EF;&#x4F7F;&#x7528;&#x6240;&#x6709;&#x529F;&#x80FD;&#x3002;" />
            </div>
        </div>
        {{--<div class="layui-form-item">--}}
