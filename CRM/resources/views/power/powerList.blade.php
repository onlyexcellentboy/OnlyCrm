...
<body>
    <div class="winui-toolbar">
        <div class="winui-tool">
            ...
            <button id="addRole" class="winui-toolbtn"><i class="fa fa-plus" aria-hidden="true"></i>新增权限</button>
            <button id="deleteRole" class="winui-toolbtn"><i class="fa fa-trash" aria-hidden="true"></i>删除选中</button>
        </div>
    </div>
    <div style="margin:auto 10px;">
        <table id="power" lay-filter="powertable"></table>
        <script type="text/html" id="barPower">
